                ...
                <form class="reform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                    <fieldset class="refieldset" style="height: 590px;">
                        ...
                        <div class="reformdiv">
                            ...
                            <br>
                            <input type="file" name="image" id="image" accept="image/jpg, image/jpeg, image/png" class="form-control <?php echo (!empty($image_err)) ? 'is-invalid' : ''; ?>" style="line-height:50px;">
                            <br>
